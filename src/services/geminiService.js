...
- ${texts.carbs}: ${carbsRounded}${language === 'en' ? 'g per day' : 'г в день'}`;
        ...
        switch (dietType) {
            case 'cutting':
                return baseInfo + `
- Приоритет: высокобелковые продукты, минимум простых углеводов
- Рекомендуемые продукты: куриная грудка, рыба, яйца, творог, овощи, крупы
- Избегать: сладости, жирное мясо, быстрые углеводы`;

            case 'keto':
                return baseInfo + `
- Приоритет: высокожировые продукты, минимум углеводов
- Рекомендуемые продукты: авокадо, орехи, масла, жирная рыба, мясо, яйца
- Избегать: хлеб, крупы, сахар, фрукты (кроме ягод)`;

            case 'paleo':
                return baseInfo + `
- Приоритет: натуральные необработанные продукты
- Рекомендуемые продукты: мясо, рыба, яйца, овощи, фрукты, орехи
- Избегать: зерновые, бобовые, молочные продукты, сахар`;

            case 'vegetarian':
                return baseInfo + `
- Приоритет: растительные белки, разнообразие источников
- Рекомендуемые продукты: бобовые, орехи, семена, яйца, молочные продукты
- Избегать: мясо, рыба`;

            case 'vegan':
                return baseInfo + `
- Приоритет: разнообразные растительные белки
- Рекомендуемые продукты: бобовые, орехи, семена, тофу, киноа, спирулина
- Избегать: все продукты животного происхождения`;

            case 'mediterranean':
                return baseInfo + `
- Приоритет: оливковое масло, рыба, овощи, цельные зерна
- Рекомендуемые продукты: рыба, оливковое масло, овощи, фрукты, орехи
- Избегать: обработанные продукты, красное мясо в больших количествах`;

            case 'lowCarb':
                return baseInfo + `
- Приоритет: белки и жиры, минимум углеводов
- Рекомендуемые продукты: мясо, рыба, яйца, овощи с низким содержанием крахмала
- Избегать: хлеб, крупы, сахар, крахмалистые овощи`;

            default:
                return baseInfo + `
- Приоритет: сбалансированное питание с акцентом на белки
- Рекомендуемые продукты: разнообразные источники белка, овощи, фрукты, цельные зерна
...
Блюдо должно содержать примерно ${Math.round(targetCalories / 4)} калорий (четверть дневной нормы).
...
ПРИМЕР ТОЧНОГО РАСЧЕТА для цели ${targetCalories} ккал:
Завтрак (${Math.round(targetCalories * 0.25)} ккал):
- Овсянка на воде 100г: 88 ккал, 3г белка, 1.7г жира, 15г углеводов
- Банан 120г: 115 ккал, 1.8г белка, 0.2г жира, 25г углеводов
- Орехи грецкие 20г: 131 ккал, 3г белка, 13г жира, 1.4г углеводов
ИТОГО завтрак: 334 ккал
...
- Огурец 100г: 15 ккал, 0.8г белка, 0.1г жира, 2.8г углеводов
- Масло подсолнечное 10г: 90 ккал, 0г белка, 10г жира, 0г углеводов
ИТОГО обед: 609 ккал

Ужин (${Math.round(targetCalories * 0.3)} ккал):
- Творог 5% 250г: 303 ккал, 43г белка, 12.5г жира, 4.5г углеводов
- Яблоко 150г: 78 ккал, 0.6г белка, 0.6г жира, 15г углеводов
ИТОГО ужин: 381 ккал

Перекус (${Math.round(targetCalories * 0.1)} ккал):
- Кефир 2.5% 200мл: 100 ккал, 5.6г белка, 5г жира, 8г углеводов

ОБЩИЙ ИТОГО: ${334 + 609 + 381 + 100} ккал (точно попадает в цель ${targetCalories} ккал)
